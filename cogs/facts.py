...
class facts:
    ...
    """Emmett's Fun Fact Cog"""
        self.bot = bot
        self.insults = fileIO("data/facts/facts.json","load")

    @commands.command(pass_context=True, no_pm=True)
    async def facts(self, ctx, user : discord.Member=None):
        """Sends interesting facts!"""
...
def check_files():
    """Moves the file from cogs to the data directory. Important -> Also changes the name to facts.json"""
